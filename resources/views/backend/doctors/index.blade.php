            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group">
                            <a class="btn btn-success" href="{{ route('admin.doctors.create') }}"> <i class="fa fa-plus"></i>  Add New</a>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach($doctors as $key=>$doctor)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td><img style="height: 50px;width: 50px;" src="{{asset($doctor->image)}}" class="media-object img-circle border-green" alt=""></td>
                                        ...
                                        <td>
                                            <a href="{{route('admin.doctors.edit',$doctor->id)}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <button type="button" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "
                                                    onclick="deleteData({{ $doctor->id }})">
