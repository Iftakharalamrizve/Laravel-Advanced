            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group">
                            <a class="btn btn-success" href="{{ route('admin.schedules.create') }}"> <i class="fa fa-plus"></i>  Add New</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach($schedules as $key=>$schedule)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.schedules.edit',$schedule->id)}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            ...
                                            <form id="delete-form-{{ $schedule->id }}"
                                                  action="{{ route('admin.schedules.destroy',$schedule->id) }}" method="POST"
                                                  style="display: none;">
                                                @csrf()
                                                @method('DELETE')
                                            </form>
