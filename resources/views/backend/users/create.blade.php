            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form class="row col-sm-12" method="post" action="{{ route('admin.users.store') }}">
                            @csrf
                            ...
                            <div class="col-sm-6 form-group">
                                <label>Email</label>
                                <input type="email" class="form-control" name="email" placeholder="Enter Email Name" required="">
                            </div>
                            <div class="col-sm-6 form-group">
