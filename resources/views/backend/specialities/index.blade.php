            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group">
                            <a class="btn btn-success" href="{{ route('admin.specialities.create') }}"> <i class="fa fa-plus"></i>  Add New</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach($specialities as $key=>$speciality)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.specialities.edit',$speciality->id)}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <button type="button" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "
                                                    onclick="deleteData({{ $speciality->id }})">
                                                <i class="fa fa-trash-o"></i>
                                            </button>
                                            <form id="delete-form-{{ $speciality->id }}"
