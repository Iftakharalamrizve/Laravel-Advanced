                        ...
                        <li>
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/nocontrol.png') }}" class="img-thumbnail" alt="User Image"></div>
                                        <h4>Nocontrol</h4>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/lab.png') }}" class="img-thumbnail" alt="User Image"></div>
                                        <h4>lab</h4>
                                ...
                                <li class="nav-list">
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/therm.jpg') }}" class="img-thumbnail" alt="User Image"></div>
                        ...
                        <li>
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/avatar2.png') }}" class="img-thumbnail" alt="User Image"></div>
                                        <h4>Alrazy</h4>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/avatar4.png') }}" class="img-thumbnail" alt="User Image"></div>
                                        <h4>Tanjil</h4>
                                        <p>Lorem Ipsum is simply dummy text of...
                                        </p>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/avatar3.png') }}" class="img-thumbnail" alt="User Image"></div>
                                        <h4>Jahir</h4>
                                        <p>Lorem Ipsum is simply dummy text of...
                                        </p>
