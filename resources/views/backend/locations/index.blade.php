            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group">
                            <a class="btn btn-success" href="{{ route('admin.locations.create') }}"> <i class="fa fa-plus"></i>  Add New</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach($locations as $key=>$location)
                                    <tr>
                                        ...
                                        <td>{{$location->name}}</td>
                                        <td>
                                            <a href="{{route('admin.locations.edit',$location->id)}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
