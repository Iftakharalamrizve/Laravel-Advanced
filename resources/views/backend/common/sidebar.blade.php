<!-- sidebar -->
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview {{Request::is('admin/doctors*')?'active':''}}">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('admin.doctors.index')}}">Doctor list</a></li>
                    <li><a href="{{route('admin.specialities.index')}}">Specialities list</a></li>
                    <li><a href="{{route('admin.educations.index')}}">Education list</a></li>
                    <li><a href="{{route('admin.schedules.index')}}">Schedule list</a></li>

                </ul>
            </li>

            {{--<li class="treeview {{Request::is('admin/specialities*')?'active':''}}">
                <a href="#">
                    <i class="fa fa-user-md"></i><span>Doctor Specialities</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{route('admin.specialities.create')}}">Add Specialities</a></li>
                    <li><a href="{{route('admin.specialities.index')}}">Specialities list</a></li>
                </ul>
            </li>--}}

            <li class="treeview {{Request::is('admin/locations*')?'active':''}}">
                <a href="#">
                    <i class="fa fa-wrench"></i><span> Settings</span>
                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.locations.index') }}">Location</a></li>
                    <li><a href="{{ route('admin.sectors.index') }}">Sector</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
