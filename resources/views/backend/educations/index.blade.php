            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group">
                            <a class="btn btn-success" href="{{ route('admin.educations.create') }}"> <i class="fa fa-plus"></i>  Add New</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach($educations as $key=>$education)
                                    <tr>
                                        ...
                                        <td>{{$education->discipline_name}}</td>
                                        <td>
                                            <a href="{{route('admin.educations.edit',$education->id)}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            ...
                                            <form id="delete-form-{{ $education->id }}"
                                                  action="{{ route('admin.educations.destroy',$education->id) }}" method="POST"
                                                  style="display: none;">
                                                @csrf()
                                                @method('DELETE')
                                            </form>
