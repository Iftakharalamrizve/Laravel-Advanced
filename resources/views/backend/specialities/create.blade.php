            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form class="row" method="post" action="{{ route('admin.specialities.store') }}">
                            @csrf
                            <div class="col-md-3"></div>
                            <div class=" col-md-6 col-sm-12 col-lg-6 offset-md-3 offset-lg-3 form-group">
                                <label>Name *</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter Name" required=""><br>
                                @error('name')
