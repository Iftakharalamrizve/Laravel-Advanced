            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group">
                            <a class="btn btn-primary" href="{{ route('admin.specialities.index') }}">
                                <i class="fa fa-backward"></i>  Back </a>
                        </div>
                    </div>
                    <div class="panel-body">
                        <form class="row" method="post" action="{{ route('admin.specialities.update',$speciality->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="col-md-3"></div>
                            <div class=" col-md-6 col-sm-12 col-lg-6 offset-md-3 offset-lg-3 form-group">
                                <label>Name</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter Name" required="" value="{{ $speciality->name }}"><br>
                                @error('name')
