...
<!-- Mirrored from thememinister.com/health/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Apr 2021 01:15:57 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>ATD Doctor Panel</title>
    ...
    <!-- Bootstrap rtl -->
    <link href="{{ asset('backend/assets/bootstrap-rtl/bootstrap-rtl.min.css') }}" rel="stylesheet" type="text/css"/>
    <!-- Lobipanel css -->
    ...
    <link href="{{ asset('backend/assets/dist/css/stylehealth-rtl.css') }}" rel="stylesheet" type="text/css"/>
...
<!-- Mirrored from thememinister.com/health/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Apr 2021 01:16:36 GMT -->
</html>
